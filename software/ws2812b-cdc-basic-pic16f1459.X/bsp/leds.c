...
#define LED_D2_LAT LATCbits.LATC4
#define LED_D3_LAT LATCbits.LATC5
#define LED_D4_LAT LATCbits.LATC6

#define LED_D1_TRIS TRISCbits.TRISC3
#define LED_D2_TRIS TRISCbits.TRISC4
#define LED_D3_TRIS TRISCbits.TRISC5
#define LED_D4_TRIS TRISCbits.TRISC6
