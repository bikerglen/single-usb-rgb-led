...
# 174
volatile BDT_ENTRY BDT[((2 + 1) * 4)] @ 0x2000;

# 179
volatile CTRL_TRF_SETUP SetupPkt @ 0x2000 + (4 * ((2 + 1) * 4));
volatile uint8_t CtrlTrfData[8] @ 0x2000 + (4 * ((2 + 1) * 4)) + 8;
...
__builtin_memcpy((uint8_t*)&SetupPkt,(uint8_t*)((void *)(pBDTEntryEP0OutCurrent->ADR)),8);
